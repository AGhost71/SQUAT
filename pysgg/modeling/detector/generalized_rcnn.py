...
class GeneralizedRCNN(nn.Module):
    ...
    def forward(self, images, targets=None, logger=None,iteration=0):
        """
        Arguments:
        ...
        if self.roi_heads:
            x, result, detector_losses = self.roi_heads(features, proposals, targets, logger,iteration=iteration)
        else:
